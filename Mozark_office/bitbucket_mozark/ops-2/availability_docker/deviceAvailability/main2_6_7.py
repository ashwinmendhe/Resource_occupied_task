# docker run -e TENANT='Mozark' -e tenant='mozark' availability

import datetime
import pytz
from device_avilability2_6_7 import *
import os
from dotenv import load_dotenv

load_dotenv()
# Access the environment variables
tenant = os.environ.get('tenant', 'DefaultTenant')  # 'DefaultTenant' is a default value if TENANT is not set
TENANT = os.environ.get('TENANT', 'DefaultTENANT')  # 'DefaultTENANT' is a default value if TENANT is not set
